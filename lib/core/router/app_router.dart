...
class AppNavigation {
  ...
  static void goToBooking(BuildContext context, String turfId, {
  ...
  static void goToPayment(BuildContext context, String bookingId, {
  ...
  static void goToPaymentSuccess(BuildContext context, String transactionId, {
    String? bookingId,
    double? amount,
  }) {
